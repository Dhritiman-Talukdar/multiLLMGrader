...
![Figure 1. per-model scatter of model score against TA consensus.](Grading_Dataset_OS/outputs/4_2_llm_vs_ta_scatter.png)

**Figure 1.** per-model scatter of model score against TA consensus.

![Figure 2. Bland–Altman agreement. The mean-difference lines sit below zero across the score range, confirming that the disagreement is a systematic offset and not a scale-dependent distortion.](Grading_Dataset_OS/outputs/5_4_bland_altman.png)
...
![Figure 6. panel (a).](docs/paper/figures/fig6_icc_as_fourth_rater.png)
...
![Figure 6. panel (b).](docs/paper/figures/fig6_icc_as_fourth_rater.png)
