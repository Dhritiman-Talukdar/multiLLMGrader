...
![Figure 2. . Bland–Altman agreement. The mean-difference lines sit below zero across the score range, which confirms a systematic offset and not a scale-dependent distortion.](Grading_Dataset_OS/outputs/5_4_bland_altman.png)
