...
| Fig | Source |
|---|---|
| 1 | OS `4_2_llm_vs_ta_scatter.png` |
| 2 | OS `5_4_bland_altman.png` |
| 3 | OS `9_5_within_human_variability.png` |
| 4 | OS `8_2_per_question_mae_heatmap.png` |
| 5 | OS `9_6_run_to_run_noise.png` |
| 7 | Bio `04_bias_by_model.png` |
| 8 | Bio `10g_radar.png` |
| 10 | OS `4_6_latency_boxplot.png` |

**To be generated** (do not exist yet):

- **Fig. 6** — ICC(2,1) as 4th rater vs. human-only baseline, both datasets side by side.
  Data: `Grading_Dataset_OS/outputs/model_ranking_human_ceiling.csv`,
  `Biomaterials/outputs/icc_4th_grader_panel.csv`. This is the headline figure.
- **Fig. 9** — cross-domain MAE-to-ceiling ratio per model, OS vs Biomaterials paired bars.
  Carries §7's replication claim.

Both generated by a committed script, styled to match existing outputs, written to
`docs/paper/figures/`.
