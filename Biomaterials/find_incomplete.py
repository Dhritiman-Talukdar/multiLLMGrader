"""
Find incomplete rows in Biomaterials grading_results CSV.

A row is considered incomplete if:
  - overall_feedback is missing (NaN, None, or empty string)
  - Any of questions 1-5 is missing from feedback_by_question
...
EXPECTED_QUESTIONS = {"1", "2", "3", "4", "5"}
CSV_PATH = "grading_results/grading_results.csv"
OUT_PATH = "grading_results/incomplete_rows.csv"
...
def main():
    ...
    for entry in incomplete_rows:
        print(
            f"  row {entry['row_index']:>4}  pdf_id={entry['pdf_id']}  "
